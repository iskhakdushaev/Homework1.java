...
public class StringUtils {
     ...
     * 5 - входящие параметры в () - то без чего невозможно выполнит данный метод
